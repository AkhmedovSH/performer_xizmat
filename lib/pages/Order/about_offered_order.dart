...
class AboutOfferedOrder extends StatefulWidget {
  const AboutOfferedOrder({Key? key}) : super(key: key);

  @override
  _AboutOfferedOrderState createState() => _AboutOfferedOrderState();
}

class _AboutOfferedOrderState extends State<AboutOfferedOrder> {
  int currentIndex = 0;
